...
| 5 | **`/so-sanh` — ẩn trường giống nhau** | ~2' | Vào `/so-sanh`. "Bảng so sánh 7 trường cốt lõi giữa 4 dự án, kèm tóm tắt pháp lý — hữu ích cho đội kinh doanh khi khách hỏi 'dự án nào phù hợp hơn'." |
