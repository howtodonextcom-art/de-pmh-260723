...
/**
 * Hardcoded PMH brand copy + seed updates feed (SPEC §5.2 brand statement,
 * ≤80 words, fact-first; SPEC §H10 updates, "3 bản ghi mới nhất").
 */
// White-label: replace SiteContent per deployment
...
export function buildSiteSettings(projects: FullProject[]): SiteSettings {
  ...
  return {
    brandStatementVi: SITE_CONTENT.brandStatementVi,
    maxLastVerifiedAt,
  };
}
