...
const score = {
    ...
    items: {
      ...
      "04_Hierarchy": {
        ...
        criteria: [
          ...
          { id: "detailDensity", pass: false, note: "AUDIT 2026-08-19 — /du-an/hong-hac-city rất dài/dày (hero+stats+masterplan+gallery+legal+related); scannable nhưng chưa editorial luxury breathing" },
        ],
      ...
      "05_Imagery": {
        ...
        criteria: [
          ...
          { id: "flipbookGallery", pass: true, note: "AUDIT 2026-08-19 — Issuu-style flipbook fullscreen (toolbar, thumbnail grid, zoom); masonry grid + category tabs retained. Signature moment nhưng chrome #111 hardcoded, tách khỏi teal brand" },
        ],
      ...
      "06_Motion": {
        ...
        criteria: [
          ...
          { id: "flipbookMotion", pass: false, note: "AUDIT 2026-08-19 — FlipbookEngine page-flip không guard useReducedMotion; toolbar zoom OK" },
        ],
      ...
      "08_Invisible": {
        ...
        criteria: [
          ...
          { id: "emptyLuxury", pass: false, note: "compare/legal Suspense fallback vẫn plain <p> text-muted-foreground" },
    ...
    items: {
      ...
      C4_DensityWhitespace: {
        ...
        criteria: [
          ...
          { id: "cardBreathing", pass: false, note: "AUDIT 2026-08-19 — detail page gallery+legal stack dense; chưa editorial whitespace luxury" },
        ],
      },
      C5_DepthAtmosphere: {
        score: 8,
  ...
  qualitative: {
    balance: "cân đối trên home/catalog; detail page dày",
    color: "teal restrained + amber meta; flipbook dùng palette riêng #111/#ededed",
    luxuryVsTemplate: "AUDIT 2026-08-19 — craft score cao (~85) nhưng perceived luxury thấp hơn (~65): polished shadcn internal hub + 1 signature flipbook moment, chưa vault editorial",
    radiusOveruse: false,
    radiusValue: "0.5rem",
    effects: "Hero cinematic + reveals + flipbook; gap: route continuity, empty states luxury, detail whitespace",
    perceivedLuxury: 6.5,
    perceivedLuxuryNote: "Cảm giác chủ quan tách khỏi automation gate — user có thể không thấy khác biệt vì 80% UI vẫn card-grid + teal shadcn",
    completionPct: 72,
    completionNote: "Hoàn thành ~72% mục tiêu vault-grade luxury internal hub; typography/color/motion craft done, editorial identity chưa",
    prodLag: "RESOLVED 2026-08-19 — prod Fraunces H1 + footer + flipbook deployed; hasMinhBach:false",
    deltaVs20260723: "LuxuryIndex flat 85; +flipbook imagery, -detail density, B4 corrected (template fade exists)",
  },
  aggregates: {},
  absoluteS5: {
    currentEstimate: 11,
